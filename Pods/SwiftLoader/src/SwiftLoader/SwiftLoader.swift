    ...
    */
    ...
    func frameForSpinner() -> CGRect {
        ...
        if (self.title == nil) {
            ...
            return CGRect(x: loaderSpinnerMarginSide, y: yOffset, width: loadingViewSize, height: loadingViewSize)//CGRect(loaderSpinnerMarginSide, yOffset, loadingViewSize, loadingViewSize)
        }
